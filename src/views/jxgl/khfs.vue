<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>考核考试方法改革</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图区域 -->
    <el-card>
      <!-- 输入框 layout 分栏布局 -->
      ...
      <el-table :data="userList" style="width: 100%" stripe border>
        ...
        <el-table-column prop="assessmentTime" label="考核时间"></el-table-column>
        <el-table-column prop="assessmentLocation" label="考核地点"></el-table-column>
        <el-table-column prop="type" label="考核类型/方法"></el-table-column>
    ...
    <el-dialog title="添加" :visible.sync="addDialogVisible" width="60%" @close="resetForm">
      ...
      <el-form :model="addForm" :rules="addFormRules" label-width="100px" ref="addFormRef" >
        ...
        <el-form-item prop="gender" label="学院名称">
         ...
         <el-form-item label="考核时间" >
          <el-form-item prop="assessmentTime">
            <el-date-picker @change="getSTime" format="yyyy-MM-dd hh:mm" value-format="yyyy-MM-dd hh:mm" type="datetime"
              placeholder="选择考核时间" v-model="addForm.assessmentTime" style="width: 100%;"></el-date-picker>
          </el-form-item>
        </el-form-item>
        <el-form-item prop="assessmentLocation" label="考核地点">
          <el-input v-model="addForm.assessmentLocation"></el-input>
        </el-form-item>
        <el-form-item prop="type" label="考核类型/方法">
      ...
      <el-form-item prop="teacherId" label="教师编号">
        ...
        <el-form-item prop="collageName" label="学院名称">
         ...
         <el-form-item label="考核时间" >
          <el-form-item prop="assessmentTime">
            <el-date-picker @change="getSTime" format="yyyy-MM-dd hh:mm" value-format="yyyy-MM-dd hh:mm" type="datetime"
              placeholder="选择考核时间" v-model="editForm.assessmentTime" style="width: 100%;"></el-date-picker>
          </el-form-item>
        </el-form-item>
        <el-form-item prop="assessmentLocation" label="考核地点">
          <el-input v-model="editForm.assessmentLocation"></el-input>
        </el-form-item>
        <el-form-item prop="type" label="考核类型/方法">
...
export default {
  ...
  methods: {
    //获取后端表单数据
    async getUserList() {
      const res = await this.$http.get('http://localhost:8092/user/select')
      // console.log(res)
      if (res.status != 200)
    ...
    add() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        this.addDialogVisible = false 
  		const res =awaitthis.$http.get('http://localhost:8092/user/insert',{params:{obj:JSON.stringify(this.addForm)}})
    ...
    async removeUserById(searchId) {
      ...
      this.userList.splice(index, 1)
  	  const res=await this.$http.delete('http://localhost:8092/user/delete',{params:{id:searchId}})
    },
    //查找用户信息
   async searchUser() {
   	this.userList.splice(0, this.userList.length)
   	const res= await this.$http.get('http://localhost:8092/user/getById',{params:{id:this.input1}})
    ...
    editUserInfo() {
      this.$refs.editFormRef.validate( async valid => {
        ...
        //关闭对话框
		 ...
		 const res =await this.$http.get('http://localhost:8092/user/update',{params:{obj:this.editForm}})
